...
public class EncryptionTest {
   ...
   public static void main(String[] args) throws Exception {
      ...
      String encryptedTextBase64 = EncryptionTest.encrypt(salt, pText.getBytes(UTF_8), PASSWORD);
      ...
      String decryptedText = EncryptionTest.decrypt(encryptedTextBase64, PASSWORD);
